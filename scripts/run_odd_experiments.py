...
from harmonica.optimize import optimize_harmonics_amp2, save_result_json
...
def main():
    res_13 = optimize_harmonics_amp2((1, 3), de_maxiter=200, de_popsize=24, de_seed=0)
    res_13579 = optimize_harmonics_amp2((1, 3, 5, 7, 9), de_maxiter=500, de_popsize=30, de_seed=0)
    ...
    print("1f+3 gain:", res_13.gain_vs_sine)
    print("1f+3+5+7+9 gain:", res_13579.gain_vs_sine)
